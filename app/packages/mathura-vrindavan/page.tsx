    ...
    try {
      const response = await fetch("/api/inquiry", {
        ...
        body: JSON.stringify({
          ...
          phone,
          email: "",
          destination: "Mathura Vrindavan Tour Package",
          message: "",
        }),
      });
    ...
    <main className="min-h-screen bg-gradient-to-br from-slate-950 via-blue-950 to-slate-900 text-white">
        ...
        <div className="relative z-10 w-full max-w-md">
          <div className="bg-white/10 backdrop-blur-xl border border-white/20 rounded-3xl p-8 shadow-2xl">
            ...
            <p className="text-center text-slate-300 mb-8">
              Krishna Janmabhoomi & Divine Braj Darshan
            </p>
            ...
            <a
              href="https://wa.me/919717367006?text=Hi%20Yorra%20Travels,%20I%20am%20interested%20in%20the%20Mathura%20Vrindavan%20Tour%20Package."
              target="_blank"
          ...
          {[
            {
              ...
              details:
                "Pickup, hotel check-in and visit Shri Krishna Janmabhoomi, Dwarkadhish Temple and Vishram Ghat.",
            },
            {
              day: "Day 2",
              title: "Vrindavan Darshan",
              details:
                "Visit Banke Bihari Temple, ISKCON Temple, Prem Mandir and enjoy the evening light show.",
            },
            {
              day: "Day 3",
              title: "Barsana & Govardhan",
              details:
                "Explore Radha Rani Temple in Barsana and Govardhan Parikrama sites.",
            },
            {
              day: "Day 4",
              title: "Departure",
              details:
                "Morning temple visit and transfer to railway station/airport.",
            },
          ].map((item, index) => (
            <div
              key={index}
          ...
          {[
            {
              ...
              desc: "Sacred birthplace of Lord Krishna.",
            },
            {
              name: "Prem Mandir",
              desc: "Magnificent marble temple with evening light show.",
            },
            {
              name: "Banke Bihari Temple",
              desc: "One of the most famous temples in Vrindavan.",
            },
            {
              name: "Govardhan",
              desc: "Holy pilgrimage site associated with Lord Krishna.",
            },
          ].map((place, index) => (
            <div
              key={index}
        ...
        <div className="grid md:grid-cols-2 gap-10">
          ...
          <div className="bg-slate-900 rounded-2xl p-8 border border-slate-800">
            ...
            <ul className="space-y-3 text-slate-300">
              ...
              <li>✔ Mathura Local Tour</li>
              <li>✔ Vrindavan Sightseeing</li>
      ...
      <section className="py-24 px-6 text-center">
        ...
        <h2 className="text-5xl font-bold mb-6">
          Ready For Mathura & Vrindavan?
        </h2>

        <p className="text-slate-300 text-lg max-w-2xl mx-auto mb-10">
          Experience the divine land of Lord Krishna, sacred temples, spiritual energy and the timeless beauty of Braj with Yorra Travels.
        </p>
