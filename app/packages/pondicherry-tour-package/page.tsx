    ...
    try {
      const response = await fetch("/api/inquiry", {
        ...
        body: JSON.stringify({
          ...
          phone,
          email: "",
          destination: "Pondicherry Tour Package",
          message: "",
        }),
      });
    ...
    <main className="min-h-screen bg-gradient-to-br from-slate-950 via-blue-950 to-slate-900 text-white">
        ...
        <div className="relative z-10 w-full max-w-md">
          <div className="bg-white/10 backdrop-blur-xl border border-white/20 rounded-3xl p-8 shadow-2xl">
            ...
            <p className="text-center text-slate-300 mb-8">
              French Colony, Beaches & Coastal Charm
            </p>
            ...
            <a
              href="https://wa.me/919717367006?text=Hi%20Yorra%20Travels,%20I%20am%20interested%20in%20the%20Pondicherry%20Tour%20Package."
              target="_blank"
          ...
          {[
            {
              ...
              details:
                "Arrival, hotel check-in and evening walk at Promenade Beach and Rock Beach.",
            },
            {
              day: "Day 2",
              title: "Pondicherry Sightseeing",
              details:
                "Visit White Town, French Quarter, Sri Aurobindo Ashram and local cafes.",
            },
            {
              day: "Day 3",
              title: "Auroville Exploration",
              details:
                "Visit Auroville, Matrimandir viewpoint and surrounding attractions.",
            },
            {
              day: "Day 4",
              title: "Paradise Beach Day",
              details:
                "Enjoy Paradise Beach, boating, photography and leisure activities.",
            },
            {
              day: "Day 5",
              title: "Departure",
              details:
                "Breakfast and transfer to airport/railway station.",
            },
          ].map((item, index) => (
            <div
              key={index}
          ...
          {[
            {
              ...
              desc: "Beautiful seaside promenade perfect for sunrise and evening walks.",
            },
            {
              name: "Auroville",
              desc: "International township known for peace and spirituality.",
            },
            {
              name: "Sri Aurobindo Ashram",
              desc: "Famous spiritual center attracting visitors worldwide.",
            },
            {
              name: "Paradise Beach",
              desc: "Pristine beach with golden sands and crystal-clear waters.",
            },
          ].map((place, index) => (
            <div
              key={index}
        ...
        <div className="grid md:grid-cols-2 gap-10">
          ...
          <div className="bg-slate-900 rounded-2xl p-8 border border-slate-800">
            ...
            <ul className="space-y-3 text-slate-300">
              ...
              <li>✔ Pondicherry Local Sightseeing</li>
              <li>✔ Auroville Visit</li>
              <li>✔ Private Cab</li>
      ...
      <section className="py-24 px-6 text-center">
        ...
        <p className="text-slate-300 text-lg max-w-2xl mx-auto mb-10">
          Discover the charm of French architecture, beautiful beaches, spiritual retreats and coastal bliss with Yorra Travels.
        </p>
