...
export default function TawangPage() {
    ...
    try {
      const response = await fetch("/api/inquiry", {
        ...
        body: JSON.stringify({
          ...
          phone,
          email: "",
          destination: "Tawang Tour Package",
          message: "",
        }),
      });
    ...
    <main className="min-h-screen bg-gradient-to-br from-slate-950 via-blue-950 to-slate-900 text-white">
        ...
        <div className="relative z-10 w-full max-w-md">
          <div className="bg-white/10 backdrop-blur-xl border border-white/20 rounded-3xl p-8 shadow-2xl">
            ...
            <p className="text-center text-slate-300 mb-8">
              Monasteries, Mountains & Arunachal Beauty
            </p>
            ...
            <a
              href="https://wa.me/919717367006?text=Hi%20Yorra%20Travels,%20I%20am%20interested%20in%20the%20Tawang%20Tour%20Package."
              target="_blank"
          ...
          {[
            {
              ...
              details:
                "Pickup from Guwahati Airport/Railway Station and overnight stay.",
            },
            {
              day: "Day 2",
              title: "Guwahati to Dirang",
              details:
                "Scenic drive through Arunachal Pradesh and overnight stay at Dirang.",
            },
            {
              day: "Day 3",
              title: "Dirang to Tawang",
              details:
                "Visit Sela Pass, Jaswant Garh War Memorial and reach Tawang.",
            },
            {
              day: "Day 4",
              title: "Tawang Local Sightseeing",
              details:
                "Explore Tawang Monastery, War Memorial and local attractions.",
            },
            {
              day: "Day 5",
              title: "Bum La Pass & Madhuri Lake",
              details:
                "Excursion to Bum La Pass, Sangetsar (Madhuri) Lake and PT Tso Lake.",
            },
            {
              day: "Day 6",
              title: "Tawang to Dirang",
              details:
                "Visit Nuranang Falls and return to Dirang for overnight stay.",
            },
            {
              day: "Day 7",
              title: "Dirang to Guwahati Departure",
              details:
                "Transfer back to Guwahati Airport/Railway Station.",
            },
          ].map((item, index) => (
            <div
              key={index}
          ...
          {[
            {
              ...
              desc: "India's largest monastery and a major Buddhist center.",
            },
            {
              name: "Sela Pass",
              desc: "Spectacular high-altitude mountain pass.",
            },
            {
              name: "Madhuri Lake",
              desc: "Beautiful lake surrounded by snow-capped mountains.",
            },
            {
              name: "Bum La Pass",
              desc: "Historic Indo-China border pass.",
            },
          ].map((place, index) => (
            <div
              key={index}
        ...
        <div className="grid md:grid-cols-2 gap-10">
          ...
          <div className="bg-slate-900 rounded-2xl p-8 border border-slate-800">
            ...
            <ul className="space-y-3 text-slate-300">
              ...
              <li>✔ Tawang Sightseeing</li>
              <li>✔ Dirang Sightseeing</li>
      ...
      <section className="py-24 px-6 text-center">
        ...
        <p className="text-slate-300 text-lg max-w-2xl mx-auto mb-10">
          Experience the breathtaking beauty of Arunachal Pradesh, ancient monasteries, snow-covered passes and unforgettable Himalayan landscapes with Yorra Travels.
        </p>
