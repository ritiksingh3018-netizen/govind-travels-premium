...
export default function AyodhyaVaranasiPage() {
    ...
    try {
      const response = await fetch("/api/inquiry", {
        ...
        body: JSON.stringify({
          ...
          phone,
          email: "",
          destination: "Ayodhya Varanasi Tour Package",
          message: "",
        }),
      });
    ...
    <main className="min-h-screen bg-gradient-to-br from-slate-950 via-blue-950 to-slate-900 text-white">
        ...
        <div className="relative z-10 w-full max-w-md">
          <div className="bg-white/10 backdrop-blur-xl border border-white/20 rounded-3xl p-8 shadow-2xl">
            ...
            <p className="text-center text-slate-300 mb-8">
              Ram Mandir, Kashi Vishwanath & Spiritual Journey
            </p>
            ...
            <a
              href="https://wa.me/919717367006?text=Hi%20Yorra%20Travels,%20I%20am%20interested%20in%20the%20Ayodhya%20Varanasi%20Tour%20Package."
              target="_blank"
          ...
          {[
            {
              ...
              details:
                "Pickup, hotel check-in and evening visit to Ram Ki Paidi and local temples.",
            },
            {
              day: "Day 2",
              title: "Ayodhya Darshan",
              details:
                "Visit Shri Ram Janmabhoomi Mandir, Hanuman Garhi, Kanak Bhawan and other sacred sites.",
            },
            {
              day: "Day 3",
              title: "Ayodhya to Varanasi",
              details:
                "Transfer to Varanasi and enjoy the famous Ganga Aarti at Dashashwamedh Ghat.",
            },
            {
              day: "Day 4",
              title: "Varanasi Sightseeing",
              details:
                "Visit Kashi Vishwanath Temple, Annapurna Temple, Sankat Mochan Temple and Sarnath.",
            },
            {
              day: "Day 5",
              title: "Departure",
              details:
                "Morning Ganga boat ride and transfer to airport/railway station.",
            },
          ].map((item, index) => (
            <div
              key={index}
          ...
          {[
            {
              ...
              desc: "Sacred birthplace of Lord Shri Ram in Ayodhya.",
            },
            {
              name: "Hanuman Garhi",
              desc: "One of Ayodhya's most revered temples.",
            },
            {
            ...
            },
            {
              ...
              desc: "Famous Ganga Aarti and spiritual atmosphere.",
            },
          ].map((place, index) => (
            <div
              key={index}
        ...
        <div className="grid md:grid-cols-2 gap-10">
          ...
          <div className="bg-slate-900 rounded-2xl p-8 border border-slate-800">
            ...
            <ul className="space-y-3 text-slate-300">
              ...
              <li>✔ Ayodhya Local Tour</li>
              <li>✔ Varanasi Sightseeing</li>
              <li>✔ Ganga Aarti Visit</li>
      ...
      <section className="py-24 px-6 text-center">
        ...
        <h2 className="text-5xl font-bold mb-6">
          Ready For Ayodhya & Varanasi?
        </h2>

        <p className="text-slate-300 text-lg max-w-2xl mx-auto mb-10">
          Experience the divine blessings of Shri Ram Janmabhoomi, Kashi Vishwanath Temple and the spiritual energy of the holy Ganga with Yorra Travels.
        </p>
